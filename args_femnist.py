...
def args_parser():
    ...
    parser.add_argument('--mu', type=float, default=0.1, help='proximal term constant for moon')
    ...
    parser.add_argument('--dataset', type=str, default='emnist', help='dataset name')
    parser.add_argument('--split', type=str, default='_2CNN', help='dataset spliting setting')
