...
def args_parser():
    ...
    parser.add_argument('--dims_feature', type=int, default=512, help="feature dimension")#192
    ...
    parser.add_argument('--dataset', type=str, default='mixed_digit', help='dataset name')
    parser.add_argument('--split', type=str, default='similarity_3CNN', help='dataset spliting setting')
    parser.add_argument('--skew', type=str, default='feature', help='distribution skew setting')
    # other arguments
